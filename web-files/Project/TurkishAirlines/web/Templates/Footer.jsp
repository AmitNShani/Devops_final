		...
		<footer class="text-center" style="color:white;background:url('./assets/img/nav.jpg'); margin-bottom:0px; margin-top:4px; padding-top:3%; padding-bottom:4px; border-top:2px solid black;">
                        <p><i>This website was copied from git for devops course final project
						<a href="https://github.com/AmitShani2020/Devops_final">link to github</a></i></p>
						<h6>Turkish Airlines 2017 &copy All Rights Reserved to </h6>
